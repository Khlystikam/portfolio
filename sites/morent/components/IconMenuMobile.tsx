            ...
            {isMobile ? (
                <>
                    <div className="favorites-cars profil-box-icons" style={{ display: state }}>
                        <img src="../assets/dev-site/assets/favorites.png" alt="favorites" />
                    </div>
                    <div className="notifications profil-box-icons" style={{ display: state }}>
                        <img src="../assets/dev-site/assets/notification.png" alt="notifications" />
                    </div>
                    <div className="profil-settings profil-box-icons" style={{ display: state }}>
                        <img src="../assets/dev-site/assets/settings.png" alt="settings" />
                    </div>
                    <div className="profil-icon profil-box-icons" onClick={handleClick}>
                        <img src="../assets/dev-site/assets/profil-icon.png" alt="profil-icon" />
                    </div>
                </>
            ) : (
                <>
